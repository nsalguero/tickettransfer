...
class PluginTickettransferTickettab extends CommonDBTM {
   ...
   static function showForm(Ticket $ticket) {
      ...
      $translations = array(
            ...
            'dest_group' => __('Destination group'),
      ...
      <form action="$action_url" method="post">
         <table class="tab_cadre_fixe">
            ...
            <tr class="tab_bg_2">
               <td>
                  <table width="100%">
                     <tr class="tab_bg_1 tickettransferrequalif">
                        <td width="30%">$translations[dest_entity]</td>
                        <td width="70%">$entities_dd</td>
                     </tr>
                     <tr class="tab_bg_2 tickettransferrequalif">
...
HTML;
      ...
      $(function() {
         ...
         function refreshTransferZone() {
            ...
            var ntype = type === 'requalif' ? 'escalation' : 'requalif';
