...
class PluginTickettransferTickettab extends CommonDBTM {
    ...
    * @param Ticket $ticket le ticket à tester
    */
...
<form action="<?php echo self::getFormURL();?>" method="post">
    ...
    * @param array $input tableau des valeurs à choisir par défaut 
    *          - entities_id entité sélectionnée
    *          - type type de catégorie sélectionné
    *          - itilcategories_id id de la catégorie à sélectionner par défaut, ou ''
    */
    ...
    * @param array $input tableau des valeurs à choisir par défaut
    *          - itilcategories_id id de la catégorie sélectionnée 
