...
if (strpos ( $_SERVER ['PHP_SELF'], "dropdownCategories.php" )) {
...
PluginTickettransferTickettab::categoriesDropdown($currententity, $currenttype, $currentcategory, $allow_empty_category);
